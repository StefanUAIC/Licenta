<script lang="ts">
	...
	import { getProfile, getUserIDFromJWT, type ProfileSchema } from '$lib/profile_api';
	...
	<div class="container mx-auto my-24">
		...
		{#if $showEditProfileModal}
			<div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center modal">
				<div class="bg-white p-8 rounded-lg shadow-lg max-w-md w-full">
					...
					<form class="z-50">
						<div class="mb-4">
							<label class="block text-gray-700 text-sm font-bold mb-2" for="firstname">First
								Name</label>
							<input
						...
						<div class="flex items-center justify-between">
							...
							<button class="btn bg-gray-600 hover:bg-gray-700 rounded-md text-white"
									type="button"
		...
		{:else if $activeTab === 'problemsProposed'}
			<div class="w-full space-y-4 text-token mt-4">
				...
				<Paginator bind:settings={problemsPaginationSettings} on:page={onPageChange}
